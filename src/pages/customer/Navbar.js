...
export const Navbar = () => {
  ...
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="https://example.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="https://example.com/logo.svg" class="h-8" alt="Example Logo"/>
      <span class="self-center text-2xl font-semibold whitespace-nowrap ">Example</span>
    </a>
